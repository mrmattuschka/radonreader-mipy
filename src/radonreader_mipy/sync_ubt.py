...
class Characteristic:
    ...
    def get_descriptor(self, uuid, rediscover=False) -> list[Descriptor]:
        """
...
class Service:
    ...
    def get_characteristic(self, uuid, rediscover=False) -> list[Characteristic]:
        """
...
class Peripheral:
    ...
    def get_service(self, uuid, rediscover=False) -> list[Service]:
        """
...
class SyncBLE:
    ...
    def connect(self, addr_type: int, addr: str):
        """
    ...
    def bt_irq(self, event, data):
        ...
        if event == IRQ_SCAN_RESULT:
            ...
            svc = Service(self.connections[conn_handle], conn_handle, start_handle, end_handle, uuid)
            ...
            crc = Characteristic(self.connections[conn_handle], conn_handle, def_handle, value_handle, properties, uuid)
            ...
            dsc = Descriptor(self.connections[conn_handle], conn_handle, dsc_handle, uuid)
